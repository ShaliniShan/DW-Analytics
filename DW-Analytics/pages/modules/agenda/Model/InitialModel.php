<?php
	...
	class InitialModel {
		...
		public function _setTimezone($time, $newzone = null, $defaultzone = 'UTC') {
			...
			//echo var_dump($date);
			//echo var_dump($newzone);
			//echo 'date in settimezone: ' . $date . '<br />';
			$date->setTimezone(new DateTimeZone($newzone));
			//echo 'date after newzone: ' . $date . '<br />';
			//echo var_dump($date);
			return $date;
		}
		/**
		...
		private function getSessionObject() {
			...
			//echo var_dump($this->eventObj->get("startDate"));
			//echo var_dump($this->eventObj->get("endDate"));
