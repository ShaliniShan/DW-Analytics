			...
			<div class="col-md-12">
				<div class="panel panel-danger">
					<div class="panel-heading">
						...
						<a style="float:right; position: relative; bottom: 25.5px;" class="btn btn-custom" href="/Organizer/admin/new-event"><i class="fa fa-plus"></i> Add Event</a>
					</div>
					<div class="panel-body">
						<!-- <table id="eventList" class="table table_pick datatable display"> -->
				    		...
				    		<tbody>
				    			<?= $adminAPI->buildEventEditTableForExhibitor($_SESSION['userID']);?> 
				    		</tbody>
			    		</table>
					</div>
				</div>
