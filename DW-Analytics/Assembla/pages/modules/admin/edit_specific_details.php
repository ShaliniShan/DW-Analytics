				...
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						...
						<div id="error_container"></div>
				          ...
				          <div class="form-group col-md-12">
				              <button name="submit_event" type='submit' onClick="return Error_checks.automaticCheck('<?=$type?>');" class="btn btn-custom btn-lg">Update Event</button>
				          	 <a id="cancelButton" href=<?=$goto_action_url ?> onMouseOver="this.style.color='#0F0'" onMouseOut="this.style.color='#00F'">Cancel</a>	
				          </div>
					    </form>
						   ...
						   <?php 
						    	...
						    	<option value="Session"  <?php echo $select ?>>Session</option>
						          ...
						          <div class="form-group col-md-12">
						              ...
						              <select data-live-search='true' data-style="input-lg btn-lg" value = '' style="background-color: #5e6870" name='beacon_session' class="form-control input-lg selectpicker" id='beacon_session' >
						         			<option selected disabled>Choose multiple Sessions if required</option>
						         		<?php echo var_dump("RadheShyam"); ?>	
