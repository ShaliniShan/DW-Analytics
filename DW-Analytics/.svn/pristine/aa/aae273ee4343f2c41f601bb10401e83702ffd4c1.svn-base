var smallBarGraph = (function () {
	...
	function appendAdditional(_theader) {
	 ...
	 _theader.innerHTML += " (" + this.getAttribute('data-name') + ")";
		...
		var file_name_actual = smallBarGraph.fileName + '-' + "Attendee-Interactions-" + MC[0].getAttribute("data-table") + '-details';
		if (MC[0].getAttribute('data-file-name')) {
		    MC[0].setAttribute('data-file-name', file_name_actual);	
		}
		//window.file_extension = this.key;
		//file_extension = '-' + MC[0].getAttribute("data-table") + '-' + this.getAttribute('data-name');
	}
	...
	function getFileName() {
		return (this.fileName + '-' +  "Attendee-Interactions-" + MC[0].getAttribute("data-table") + '-details');
	}
	return {
		plotBarGraph : init,
		loadData : loadData,
		...
		specific_file : MC[0] ? ("Attendee-Interactions-" + MC[0].getAttribute("data-table")) : '',
